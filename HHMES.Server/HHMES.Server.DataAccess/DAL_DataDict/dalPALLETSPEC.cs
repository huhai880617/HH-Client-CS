...
namespace HHMES.Server.DataAccess
{
    ...
    /// dalPALLETSPEC
    /// </summary>
    public class dalPALLETSPEC : dalBaseDataDict, IBridge_PALLETSPEC
    {
         /// <summary>
         /// 构造器
         /// </summary>
         /// <param name="loginer">当前登录用户</param>
         public dalPALLETSPEC(Loginer loginer): base(loginer)
         {
             _KeyName = tb_PALLETSPEC.__KeyName; //主键字段
             _TableName = tb_PALLETSPEC.__TableName;//表名
             _ModelType = typeof(tb_PALLETSPEC);
         }
         ...
         {
           Type ORM = null;
           if (tableName == tb_PALLETSPEC.__TableName) ORM = typeof(tb_PALLETSPEC);
