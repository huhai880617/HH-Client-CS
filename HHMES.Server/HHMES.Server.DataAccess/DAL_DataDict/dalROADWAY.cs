...
namespace HHMES.Server.DataAccess
{
    ...
    /// dalROADWAY
    /// </summary>
    public class dalROADWAY : dalBaseDataDict, IBridge_ROADWAY
    {
         /// <summary>
         /// 构造器
         /// </summary>
         /// <param name="loginer">当前登录用户</param>
         public dalROADWAY(Loginer loginer): base(loginer)
         {
             _KeyName = tb_ROADWAY.__KeyName; //主键字段
             _TableName = tb_ROADWAY.__TableName;//表名
             _ModelType = typeof(tb_ROADWAY);
         }
         ...
         {
           Type ORM = null;
           if (tableName == tb_ROADWAY.__TableName) ORM = typeof(tb_ROADWAY);
