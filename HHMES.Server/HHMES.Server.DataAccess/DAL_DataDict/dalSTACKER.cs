...
namespace HHMES.Server.DataAccess
{
    ...
    /// dalSTACKER
    /// </summary>
    public class dalSTACKER : dalBaseDataDict, IBridge_STACKER
    {
         /// <summary>
         /// 构造器
         /// </summary>
         /// <param name="loginer">当前登录用户</param>
         public dalSTACKER(Loginer loginer): base(loginer)
         {
             _KeyName = tb_STACKER.__KeyName; //主键字段
             _TableName = tb_STACKER.__TableName;//表名
             _ModelType = typeof(tb_STACKER);
         }
         ...
         {
           Type ORM = null;
           if (tableName == tb_STACKER.__TableName) ORM = typeof(tb_STACKER);
