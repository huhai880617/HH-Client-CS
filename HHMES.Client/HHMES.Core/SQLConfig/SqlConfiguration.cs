...
namespace HHMES.Core
{
    ...
    public class SqlConfiguration
    {
        ...
        ///  SQL的连接参数配置注册表路径
        /// </summary>
        public const string REG_SQL_CFG = @"SOFTWARE\HHMES\V3.01\SQL";

        /// <summary>
        /// INI配置文件
        /// </summary>
        public const string INI_CFG_PATH = @"\Config\HHMES.ini";
        ...
        {
            if (config == null) throw new Exception("Program cann't run without a SQL configuration.You should config the SQL connection by running HHMES.Tools.SqlConnector.exe!");
