...
namespace HHMES.Models
{
    ...
    ///<summary>
    /// ORM模型, 数据表:WMS_StockDtl,由ClassGenerator自动生成
   ...
   ///       bool isForeignKey, bool isDocFieldName)
    /// </summary>
    [ORM_ObjectClassAttribute("WMS_StockDtl", "IsId", true)]
    public sealed class tb_WMS_StockDtl
    {
        public static string __TableName = "WMS_StockDtl";
