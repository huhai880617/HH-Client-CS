...
namespace HHMES.Models
{
    ...
    /*==========================================
     *   程序说明: tb_WARECELL的ORM模型
     *   作者姓名: HHMES.com
     *   创建日期: 2018-05-01 08:44:27
     *   最后修改: 2018-05-01 08:44:27
     *   
    ...
    ///<summary>
    /// ORM模型, 数据表:WARECELL,由ClassGenerator自动生成
    /// </summary>
    [ORM_ObjectClassAttribute("WARECELL", "ID", true)]
    public sealed class tb_WARECELL
    {
        public static string __TableName = "WARECELL";
        ...
        public static string PALLETID = "PALLETID";

        [ORM_FieldAttribute(SqlDbType.Int, 4, false, true, false, true, false)]
        public static string ZONEID = "ZONEID";

        [ORM_FieldAttribute(SqlDbType.Int, 4, false, true, false, true, false)]
        public static string WARECELLSPECID = "WARECELLSPECID";
        ...
        [ORM_FieldAttribute(SqlDbType.Int, 4, false, true, false, false, false)]
        public static string NCOLUMN = "NCOLUMN";

        [ORM_FieldAttribute(SqlDbType.Int, 4, false, true, false, false, false)]
        public static string NLAYER = "NLAYER";
