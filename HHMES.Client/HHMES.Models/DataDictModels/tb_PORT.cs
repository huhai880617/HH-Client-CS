...
namespace HHMES.Models
{
    ...
    ///<summary>
    /// ORM模型, 数据表:PORT,由ClassGenerator自动生成
    /// </summary>
    [ORM_ObjectClassAttribute("PORT", "ID", true)]
    public sealed class tb_PORT
    {
        public static string __TableName = "PORT";
        ...
        [ORM_FieldAttribute(SqlDbType.Bit, 1, false, true, false, false, false)]
        public static string ISINPORT = "ISINPORT";

        [ORM_FieldAttribute(SqlDbType.Bit, 1, false, true, false, false, false)]
        public static string ISOUTPORT = "ISOUTPORT";

        [ORM_FieldAttribute(SqlDbType.Bit, 1, false, true, false, false, false)]
        public static string ISCHECKPORT = "ISCHECKPORT";

        [ORM_FieldAttribute(SqlDbType.Bit, 1, false, true, false, false, false)]
        public static string ISSORTPORT = "ISSORTPORT";

        [ORM_FieldAttribute(SqlDbType.Bit, 1, false, true, false, false, false)]
        public static string ISSEEPORT = "ISSEEPORT";

        [ORM_FieldAttribute(SqlDbType.Bit, 1, false, true, false, false, false)]
        public static string ISINVENTORYPORT = "ISINVENTORYPORT";
