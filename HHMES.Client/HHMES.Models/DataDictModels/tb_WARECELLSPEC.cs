...
namespace HHMES.Models
{
    ...
    /*==========================================
     *   程序说明: tb_WARECELLSPEC的ORM模型
     *   作者姓名: HHMES.com
     *   创建日期: 2018-05-01 08:46:00
     *   最后修改: 2018-05-01 08:46:00
     *   
    ...
    ///<summary>
    /// ORM模型, 数据表:WARECELLSPEC,由ClassGenerator自动生成
    /// </summary>
    [ORM_ObjectClassAttribute("WARECELLSPEC", "ID", true)]
    public sealed class tb_WARECELLSPEC
    {
        public static string __TableName = "WARECELLSPEC";
        ...
        [ORM_FieldAttribute(SqlDbType.NVarChar, 100, false, true, false, false, false)]
        public static string VOLUMN = "VOLUMN";
