...
namespace HHMES.ORM
{
    ...
    public partial class STOCKTAKINGBILL_DETAIL
    {
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2214:DoNotCallOverridableMethodsInConstructors")]
        public STOCKTAKINGBILL_DETAIL()
        {
            this.TASK_DETAIL = new HashSet<TASK_DETAIL>();
        }
    
        public int ID { get; set; }
        public int STOCKTAKINGBILL_HEADERID { get; set; }
        ...
        public Nullable<int> STOCKTAKINGACTUALQTY { get; set; }
        public string STOCKTAKINGBATCH { get; set; }
