...
namespace HHMES.ORM
{
    ...
    public class GenerateDAL
    {
        ...
        public string GenerateDataDictDAL(Params4DataDictDAL param)
        {
            ...
            builder.AppendLine("    /// </summary>");
            builder.AppendLine("    public class " + param.DAL_Name + " : dalBaseDataDict, IBridge_"+param.ConcretelyName); //基类
            builder.AppendLine("    {");
            builder.AppendLine("         /// <summary>");
        ...
        public string GenerateBusinessDAL(Params4BusinessDAL param)
        {
            ...
            builder.AppendLine("    /// " + param.DAL_Name);
            builder.AppendLine("    /// </summary>");
            builder.AppendLine("    public class " + param.DAL_Name + " : dalBaseBusiness,IBridge_" + param.ConcretelyName); //基类
            builder.AppendLine("    {");
            builder.AppendLine("         /// <summary>");
            builder.AppendLine("         /// 构造器");
            builder.AppendLine("         /// </summary>");
            ...
            builder.AppendLine("              //ds.Tables[1].TableName =" + param.ORM_Name + "Dtl.__TableName;//明细表");
            ...
            builder.AppendLine("              string sql1 = \"UPDATE [" + param.ConcretelyName + "] SET Amount=0 where [\"+" + param.ORM_Name + ".__KeyName+\"]=@DocNo1 \";");
            builder.AppendLine("              string sql2 = \"delete [" + param.ConcretelyName + "] where [\"+" + param.ORM_Name + ".__KeyName+\"]=@DocNo2 \";");
            builder.AppendLine("              SqlCommandBase cmd = SqlBuilder.BuildSqlCommandBase(sql1 + sql2);");
            builder.AppendLine("              cmd.AddParam(\"@DocNo1\", SqlDbType.VarChar, docNo.Trim());");
            builder.AppendLine("              cmd.AddParam(\"@DocNo2\", SqlDbType.VarChar, docNo.Trim());");
