...
using HHMES.WebServiceReference.WCF_SalesModuleService;
using HHMES.WebServiceReference.WCF_DataDictService;
using HHMES.WebServiceReference.WCF_SystemSecurityService;
using HHMES.Common;
using HHMES.WebServiceReference.WCF_PurchaseModuleService;
using HHMES.WebServiceReference.WCF_InventoryModuleService;
using HHMES.WebServiceReference.WCF_AccountModuleService;
namespace HHMES.WebServiceReference
{
