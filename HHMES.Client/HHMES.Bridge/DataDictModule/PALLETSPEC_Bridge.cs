...
{
    public class ADODirect_PALLETSPEC
    {
        private IBridge_PALLETSPEC _DAL_Instance = null;//数据层实例

        public ADODirect_PALLETSPEC()
        {
            _DAL_Instance = new dalPALLETSPEC(Loginer.CurrentUser);
        }

        public IBridge_PALLETSPEC GetInstance()
        {
    ...
    public class WebService_PALLETSPEC : IBridge_PALLETSPEC
    {
        public WebService_PALLETSPEC()
        {
        }

        #region IBridge_PALLETSPEC 成员
