...
{
    public class ADODirect_STACKER
    {
        private IBridge_STACKER _DAL_Instance = null;//数据层实例

        public ADODirect_STACKER()
        {
            _DAL_Instance = new dalSTACKER(Loginer.CurrentUser);
        }

        public IBridge_STACKER GetInstance()
        {
    ...
    public class WebService_STACKER : IBridge_STACKER
    {
        public WebService_STACKER()
        {
        }

        #region IBridge_STACKER 成员
