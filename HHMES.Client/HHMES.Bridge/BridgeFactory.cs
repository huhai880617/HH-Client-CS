...
using HHMES.Bridge.CommonBridge;
...
namespace HHMES.Bridge
{
    ...
    public class BridgeFactory
    {
        ...
        /// 数据访问层模块文件名
        /// </summary>
        public const string DLL_FILE_NAME = "HHMES.Server.DataAccess.dll";
        ...
        public static bool InitializeBridge()
        {
            ...
            try
            {
                ...
                if (BridgeType.ADODirect == BridgeType)
                {
                    ...
                    //IWriteSQLConfigValue cfgSQLExpress = new SQLExpressCfg(Application.StartupPath + @"\HHMES.ini");
