...
namespace HHMES.Business.BLL_Business
{
    public class bllUnknow : bllBaseBusiness
    {
        ...
        public override System.Data.DataSet CreateSaveData(System.Data.DataSet sourceData, HHMES.Common.UpdateType currentType)
        {
            Msg.Warning("请实现功能！");
            return sourceData;
        }
        ...
        public override HHMES.Common.SaveResult Save(DataSet saveData)
        {
            Msg.Warning("请实现功能！");
