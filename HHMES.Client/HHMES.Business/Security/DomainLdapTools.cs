...
namespace HHMES.Business.Security
{
    /// <summary>
    /// Windows目录服务工具包
    /// </summary>
    public class DomainLdapTools
    {
        ...
        /// 从活动目录中搜索对象
        /// </summary>
        /// <param name="domainADPath">如：HHMES.mo</param>
        ...
        /// 创建一个目录入口．
        /// </summary>
        /// <param name="domainADPath">AD路径,如：HHMES.mo</param>
        /// <returns></returns>
        public static DirectoryEntry CreateDirectoryEntry(string domainADPath)
        {
            DirectoryEntry de = new DirectoryEntry(domainADPath); //HHMES.mo
